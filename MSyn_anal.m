...
Msyn= 20:5:N; % experimentally determined fixed average number of synaptic inputs per neuron
...
for e=1:length(Msyn)
    ...
    for t=2:T/dt
        ...
        %if (t > 1000/.5)
            I = Iapp;
        %end
            [V(i,t),n(i,t),h(i,t),s(i,t)] = hodgkin_huxley_synapse_msyn(dt,[n(i,t-1),h(i,t-1)],V_last,s_last,i,I,Esyn,ps(i,:),Msyn(e));
            if ((V(i,t) > -10) && (V(i,t-1) < -10)) 
                spiketrain(i,t) = 1;
            end
        end
    end
...
title(strcat('Network Synchrony varies with # of synaptic inputs per neuron N = ',num2str(N)))
